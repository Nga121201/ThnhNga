...
<body data-scroll-animation="true">
  <div class="body_wrapper">
    ...
    <!--================End Preloader Area =================-->
       <!--================Mobile Canvus Menu Area =================-->
                ...
                <ul class="menu_list wd_scroll">
                    ...
                    <li class="active">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="vaccine.php">Vaccine phòng COVID-19</a>
                            </li><li><a href="faq.php">FAQS</a></li>
                        </ul>
                    </li>
        ...
        <section class="sample_page_area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="sample_page_inner">
     ...
     <?php 
                    ...
                    {
                    ;?>
                            <div class="row sample_page_inner">
                        <div class="sample_page_inner"> 
                            <div class="sample_page_img">
                                <img style="width: 570px; height: 430px;" 
                                class="img-fluid" src="<?php echo $row['anh_minh_hoa'] ? 'assets/images/vaccine'.$row['anh_minh_hoa'] :'assets/images/vaccine/thu.jpg';?>" alt="" />
                            </div>
                            <div class="sample_page_text">
                                <div class="sample_page_btm_text">
                                    <div class="tag"><h5><?php echo $row["ten_vaccine"];?></h5></div>
                                    <div class="author">
                                      <a>by <?php echo $row["mo_ta"];?>  </a>    
                                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="right_sidebar">
                            <aside class="right_widget post_widget">
                                ...
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="assets/images/blog/tranding-post/post-2.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>Bắt đầu tiêm vắc xin Covid-19 cho phụ nữ mang thai,bà mẹ đang cho con bú</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="assets/images/blog/tranding-post/post-3.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                        <h4>"Chìa khóa" để chấm dứt Covid-19</h4>
                                    </div>
                                </div>
                            </aside>
 ...
 <!--================App Area =================-->
    ...
    <!--================End App Area =================-->
        ...
        <!--================End Client Logo Area =================-->    <!--================Footer Area =================-->
